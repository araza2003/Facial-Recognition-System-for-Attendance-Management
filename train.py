...
class Train:
    def __init__(self, root):
        ...
        img_top = Image.open(r"images\Screenshot 2024-04-18 171755.png")
        ...
        # Button
        b1_1 = Button(self.root, text="TRAIN DATA", cursor="hand2", font=("times new roman", 30, "bold"), bg="red", fg="white", command=self.train_classifier)
